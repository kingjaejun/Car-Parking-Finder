        ...
        return(
            <View style={styles.header}>
                <View style={{flex:1, justifyContent:'center'}}>
                    ...
                    <Text style={styles.headerLocation}>SouthKorea, Pus
                    ...
                    <View style={styles.modalInfo}>
                        ...
                        <View>
                            <TouchableOpacity style={styles.payBtn}>
                                ...
                                <FontAwesome name='angle-right' size={theme.SIZES.icon*1.75} color={theme.COLORS.gray} />
                            </TouchableOpacity>
                        </View>
                    </View>
            </Modal>
